...
<html lang="en">
  ...
  <div class="container-fluid">
    <ul class="nav nav-tabs" role="tablist">
      ...
      <li role="presentation" class="active"><a href="<?php echo base_url('kriteria/preferensi'); ?>" role="tab">Nilai Perbandingan Berpasangan</a></li>
  ...
  <div class="container-fluid">
    <div class="table-responsive">
      <table class="table table-striped table-hover">
        ...
        <?php for ($i = 0; $i < 5; $i++) { ?>
          <tr>
            <th><strong><?= $nama[$i]->nama_kriteria ?></strong></th>
            <?php for ($j = 0; $j < 5; $j++) { ?>
              <?php $val = ($i*5)+$j ?>
              <th><?= $data[$val]->nilai ?></th>
            <?php } ?>
          </tr>
        <?php } ?>
      </table>
...
<br>
  <div class="container-fluid">
    <h4>Tabel Perbandingan Berpasangan Ternormalisasi</h4>
  </div>
    <div class="container-fluid">
      <div class="table-responsive">
        <table class="table table-striped table-hover">
