...
<html lang="en">
  ...
  <div class="container-fluid">
    ...
    <div class="col-md-6 text-right">
      <button type="button" onclick="location.href='<?php echo base_url('user/tambah') ?>'" class="btn btn-primary">Tambah User</button>
    </div>
  </div>
    <div class="container-fluid">
        ...
        <table class="table table-striped table-hover">
          ...
          {?>
            <tr>
              ...
              <td>
                <a href="<?php echo base_url("user/edit/$row->username") ?>" class="btn btn-warning"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span></a>
  					    <a href="<?php echo base_url("user/hapus/$row->username")?>" onclick="return confirm('Yakin ingin menghapus data')" class="btn btn-danger"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
              </td>
            </tr>
            <?php $no++; ?>
          <?php
