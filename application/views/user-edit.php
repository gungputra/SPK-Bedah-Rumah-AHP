    ...
    <div class="container-fluid">
		...
		<div class="row">
		  <div class="col-xs-12 col-sm-12 col-md-12">
			  ...
			  <h5><strong>Edit Pengguna untuk Saudara <?php echo $data[0]->nama ?></strong></h5>
			</div>
        ...
        <form method="post" action="<?= base_url('user/update') ?>">
            ...
            <label for="username"><strong>Username</strong></label>
				    <input type="text" class="form-control" id="username" name="username" required value="<?php echo $data[0]->username ?>">
