...
<html lang="en">
  ...
  <div class="container-fluid">
    <ul class="nav nav-tabs" role="tablist">
      <li role="presentation"><a href="<?php echo base_url('alternatif/'); ?>" role="tab">Administrasi Data Alternatif</a></li>
      <li role="presentation" class="active"><a href="<?php echo base_url('alternatif/normalisasi'); ?>" role="tab">Data Alternatif Ternormalisasi</a></li>
  	</ul>
  </div>
  <div class="container-fluid">
    <div class="row container-fluid">
    <div class="col-md-6 col-xs-6 text-left">
      <h4>Data Alternatif Ternormalisasi</h4>
    </div>
